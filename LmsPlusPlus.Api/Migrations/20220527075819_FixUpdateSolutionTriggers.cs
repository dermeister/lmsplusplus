...
{
    public partial class FixUpdateSolutionTriggers : Migration
    {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    IF NOT EXISTS (SELECT 1 FROM users
                        JOIN m2m_users_groups ON users.id = m2m_users_groups.user_id
                        JOIN groups ON m2m_users_groups.group_id = groups.id
