...
namespace LmsPlusPlus.Api.Migrations
{
    ...
    [Migration("20220606170212_UpdatePermissionsEntity")]
            ...
            modelBuilder.Entity("LmsPlusPlus.Api.Infrastructure.Group", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name", "TopicId" }, "unq_groups_name_topic_id")
                        .IsUnique()
                        .HasDatabaseName("ix_groups_name_topic_id");
            ...
            modelBuilder.Entity("LmsPlusPlus.Api.Infrastructure.Permissions", b =>
                {
                    ...
                    b.Property<bool>("CanViewAllSolutions")
                        .HasColumnType("boolean")
                        .HasColumnName("can_view_all_solutions");

                    b.Property<bool>("HasVcsAccounts")
                        .HasColumnType("boolean")
                        .HasColumnName("has_vcs_accounts");
